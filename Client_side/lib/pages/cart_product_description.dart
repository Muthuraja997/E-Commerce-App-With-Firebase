...
class CartProductDescription extends StatelessWidget {
  const CartProductDescription({super.key});
  @override
            ...
            const SizedBox(height: 20,),
             SizedBox(
              ...
              child: ElevatedButton(
                ...
                onPressed:(){
                ctrl.deleteproductcart(products.id??'');
                ctrl.update();
                }
                , child: const Text('Remove From Cart',style: TextStyle(fontSize: 18,color: Colors.white),),),
            ),
            const SizedBox(height: 20,),
            SizedBox(
              width: double.infinity,
